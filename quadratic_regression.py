...
class ConeVisualisation(Node):
    ...
    def listener_callback(self, msg):
        ...
        if len(cone_points_list) > 0:
            ...
            clustering = DBSCAN(eps=1, min_samples=3).fit(cone_points[:, :3]) # HERE INTENSITY GETS LOST
        ...
        for val in clusters.values():
            ...
            if len(z_vals) >= 3:
                ...
                if int_mid > int_start:
                    cone_type = 0.0
                elif int_mid < int_start:
                    cone_type = 1.0
                else:
                    cone_type = 0.5
        ...
        for pt in self.cone_points_cent:
            ...
            marker.lifetime = Duration(sec=0, nanosec=000000000)  # 0.5 seconds
